...
<body>
	...
	<pre>
		...
		- c:remove 속성
		1) var : 삭제할 변수명, page, session 등등 모든 변수가 삭제됨 requestscope를 쓰면 그것만 삭제됨
	...
	<pre>
		...
		- 단, escapeXml="true" (true가 기본값) 설정 시
			html 태그가 해석 X
	...
	<!-- 상대경로 
		...
		현재 경로 : http://localhost:8080/jstl/condition
